...
class LinkyDataModule(FineTuningDataModule, IOMixin):
    """A data module for fine-tuning on the linky dataset.

    This class inherits from the `FineTuningDataModule` class and is specifically designed for fine-tuning models on the
    "linky" dataset. It handles data download, preprocessing, splitting, and preparing the data
    ...
    def __init__(
        ...
        super().__init__(
            dataset_root=get_dataset_root("linky"),
    ...
    def _preprocess_and_split_data(self, dset, train_ratio: float = 0.95, val_ratio: float = 0.05):
